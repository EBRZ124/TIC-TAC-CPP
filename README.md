...
Current state - no graphical elements besides charecter outputs, played by entering the corresponding number which represents one of the nine fields in a 3x3 grid.

WIP - a GUI using Raylib library https://github.com/raysan5/raylib 
